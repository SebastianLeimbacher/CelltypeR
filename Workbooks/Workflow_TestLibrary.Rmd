...
express.by.cluster <- as.data.frame(AverageExpression(seu, features = AB,
                                                        group.by = "CellType", slot = 'scale.data'))
...
new.order <- c("unknown", "astrocyte","epithelial",	"neurons 1",
               "astrocyte","astrocyte", "endothelial","astrocyte",
               "neurons 1", "npc", "endothelial","astrocyte")
