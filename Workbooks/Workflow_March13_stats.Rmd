...
## clustree in phenograph doesn't make sense 
#
...
write.csv(df.for.stats, "/Users/rhalenathomas/Documents/Data/FlowCytometry/PhenoID/Analysis/testingLibrary/df4statsMarch13.csv")
...
# we run one-way or two-way anova with interaction effects.


test.stats5 <- runstats(input_df= df.for.stats, group_cols = c("Sample", "CellType","Marker","Genotype","Batch"),
                     value_col = "value",
                     stat_type = "ANOVA", dp1 = 'Genotype', 
                     dp2 = NULL, use_means = TRUE,
                     loop_by = "CellType")


test.stats2 <- runstats(input_df= df.for.stats, group_cols = c("Sample", "CellType","Marker","Genotype","Batch"),
                     value_col = "value",
                     stat_type = "ANOVA", dp1 = 'Genotype', 
                     dp2 = NULL, use_means = TRUE,
                     loop_by = "Marker")
...
test.stats3 <- runstats(input_df= df.for.stats, group_cols = c("Sample", "CellType","Marker","Genotype","Batch"),
                     value_col = "value",
                     stat_type = "ANOVA", dp1 = 'Genotype', 
                     dp2 = NULL, use_means = FALSE,
                     loop_by = "Marker")


test.stats4 <- runstats(input_df= df.for.stats, group_cols = c("Sample", "CellType","Marker","Genotype","Batch"),
                     value_col = "value",
                     stat_type = "ANOVA", dp1 = 'Genotype', 
                     dp2 = NULL, use_means = TRUE,
                     loop_by = 'none')
...
as.data.frame(test.stats5$unknown$ANOVA)
