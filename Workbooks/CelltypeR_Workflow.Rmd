...
Define which meausures have one or two peaks and align peaks
...
Note this is needed for louvain clustering using seurat however it is only for visualization for the flowsom and phenograph clustering. 
