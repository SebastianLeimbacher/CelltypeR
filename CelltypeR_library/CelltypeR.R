...
# clust_stability
 select cluster method and one pararmeter to vary (resolutions 0.1,0.3,0.5,0.8). runs n iterations randomizing starting point - default 100
