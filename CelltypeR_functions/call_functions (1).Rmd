...
source("Annotate_Clusters_Shumingupdatednov6.R")
```


```{r}
# #preprocessing function in Create_clusters
...
```{r}
#main function in Create_clusters:
...
test6 <- find_correlation(test = test, 
                          reference = reference, 
                          min_corr = 0.1, 
                          min_diff = 0.05)

test7 <- plot_corr(test6)
```
